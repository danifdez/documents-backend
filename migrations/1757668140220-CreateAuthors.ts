...
export class CreateAuthors1757668140220 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "authors" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_authors" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "resource_authors" ("resource_id" integer NOT NULL, "author_id" integer NOT NULL, "created_at" TIMESTAMP DEFAULT now(), CONSTRAINT "PK_resource_authors" PRIMARY KEY ("resource_id", "author_id"))`);
