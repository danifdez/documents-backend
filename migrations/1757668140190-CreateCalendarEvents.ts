...
export class CreateCalendarEvents1757668140190 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "calendar_events" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" text, "start_date" TIMESTAMP WITH TIME ZONE NOT NULL, "end_date" TIMESTAMP WITH TIME ZONE, "color" character varying DEFAULT '#3b82f6', "all_day" boolean NOT NULL DEFAULT false, "recurrence_rule" text, "alarm" jsonb, "track_completion" boolean NOT NULL DEFAULT false, "projectId" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_calendar_events" PRIMARY KEY ("id"))`);
