...
export class AddArchiveStatus1757668140040 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "threads" ADD COLUMN "status" VARCHAR(16) NOT NULL DEFAULT 'active'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "docs" ADD COLUMN "status" VARCHAR(16) NOT NULL DEFAULT 'active'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "resources" ADD COLUMN "archived_at" TIMESTAMP NULL`,
    );
    await queryRunner.query(
