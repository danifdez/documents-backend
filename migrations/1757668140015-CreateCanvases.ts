...
export class CreateCanvases1757668140015 implements MigrationInterface {
    name = 'CreateCanvases1757668140015'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "canvases" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "canvas_data" jsonb, "content" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "threadId" integer, "projectId" integer, CONSTRAINT "PK_canvases_id" PRIMARY KEY ("id"))`);
